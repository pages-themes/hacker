...
Loading the DLL in Ghidra a checking out dllmain_dispatch, we are directed towards a couple of jumps that lead to this function at memory address `0x180013860`. Here's a decompiled version of it.
```c++
